...
if($_POST['senderid'] != 0 )
{
	echo $_SESSION['senderid'] = $_POST['senderid'];
}
...
if($_POST['message'] != "")
{
	$sql ="INSERT INTO message(sender_id,receiver_id,message_date_time,product_id,message,status) values('$_SESSION[senderid]','$_SESSION[receiverid]','$dttim','$_SESSION[productid]','$_POST[message]','Customer')";
