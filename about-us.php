                ...
                <section>
                    <div class="container">
                        ...
                        <div class="mg_hotel_hd1">
                            <h4>Know More About The Travel way</h4>
                        </div>
                        <!-- iqoniq Heading End -->
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="mg_services">
                                    ...
                                    <p>Come and Visit most famous tourist places in sri lanka..</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="mg_services">
                                    ...
                                    <p>Book at Over 1000 Hotels All over Sri lanka. Quick, Easy Booking. Great Rates.</p>
                                </div>
                            </div>
                            <!-- iqoniq Travel Services End -->
                            <!-- iqoniq Travel Services Start -->
                ...
                <section class="mg_travelplan">
                    <div class="container">
                        ...
                        <div class="mg_plan_caption">
                            <p>The travel way, Sri lanka's leading online travel & Tourism company, has a profound understanding of Sri lankan consumers travel needs and preferences. It offers a wide range of holiday packages in Sri lanka, catering to various segments of travellers. While the dynamic or customized tour and travel packages give consumers an option to create and design their own holiday, the fixed departure holiday packages have a pre-designed itinerary; thus ensuring there is something to meet the holiday needs of every kind of traveller.</p>
                        </div>
                        <!-- Caption End -->
                    </div>
                </section>
