...
if(isset($_POST['form_email'])) {
	...
	$form_services = $_POST['form_services']; // required
	...
	$email_message .= "Services: ".clean_string($form_services)."\n";
    $email_message .= "Messages: ".clean_string($form_message)."\n";
