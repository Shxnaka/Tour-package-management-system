...
$bookdttime = date("d-M-Y",strtotime($rs['booking_datetime'])). " " . date("h:i A",strtotime($rs['booking_datetime']));
		echo "<tr>
	...
	<thead>
		...
		<tr>
			...
			<tr>
				...
				<th style="width:75%;"><input name="card_no" id="card_no" type="text" class="form-control"></th>
			</tr>
			<?php
			/*
			<tr>
				<th style="width:25%;">Expiry Date</th>
				<th style="width:75%;"><input name="exp_date" id="exp_date" type="month" class="form-control" min="<?php echo $minmonth; ?>" ></th>
			</tr>
			*/
			?>
